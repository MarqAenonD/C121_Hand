...
classifier = ml5.imageClassifier("https://teachablemachine.withgoogle.com/models/ncTfpaWFo/model.json", modelLoaded);
...
function gotResult(error, results) {
    if (error) {
        ...
        if (results[0].label == "fist closed") {
            document.getElementById("update_hand").innerHTML = "&#9994;"
        }
        ...
        if (results[1].label == "fist closed") {
            document.getElementById("update_hand2").innerHTML = "&#9994;"
        }
    }
}